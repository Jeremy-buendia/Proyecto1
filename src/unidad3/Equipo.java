...
public class Equipo implements Comparable<Equipo> {
	...
	/**
	 * 
	 * Funcion que recibe un jugador y lo añade a nuestra lista de jugadores Buscara
	 * el primer espacio vacio de nuestro array para insertarlo
	 * 
	 * @param nuevoJugador
	 * @return
	 */
	...
	/**
	 * Funcion que busca un jugador en un equipo contrario y devuelve la posicion
	 * dentro de su lista de jugadores
	 * 
	 * @param idJugador
	 * @param equipo
	 * @return
	...
	/**
	 * La función ficha a un jugador del equipo que recibe como parametro
	 * 
