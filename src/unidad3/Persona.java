...
public class Persona {
	...
	/**
	 * Metodo Constructor Es el que se ejecuta cuando creamos un objeto con new
	 * Persona Este constructor se denomina el constructor vacio ya que no recibe
	 * ningun dato como parametro
	 */
	public Persona() {
