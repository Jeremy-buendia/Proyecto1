...
public class Calculadora {
	 ...
	 *          <tipo_devolver> nombre_funcion(<param1>,<param2>,...) { codigo }
	 * 
	 * 
	 */
	...
	/**
	 * Recibe un array de enteros y devuelve el valor minimo
	 * 
	 ...
	 * @return posicion donde esta el número, -1 si no esta
	 */
	...
	public int[] recorte(int[] arrayOrigen, int posIn, int posFin) {
		// Nuevo array del corte
		int[] recorte;
		// Calculamos el tamaño del array
		recorte = new int[posFin - posIn];

		// Bucle que recorre el array original en las posiciones indicadas
		for (int i = posIn; i < posFin; i++) {
			// Bucle que introduce los valores del corte en el nuevo array
			for (int j = 0; j < recorte.length; j++) {
				recorte[j] = arrayOrigen[i];
			}
		}
		// devuelve el array
		return recorte;
